    ...
    >
      <Form className="flex flex-col gap-4 w-full max-w-lg">
        <Field
          ...
          autoComplete="off"
          autoFocus={true}
          className="p-4 rounded-lg bg-veryDarkGray border-secondary border-1 placeholder-mutedGray focus:outline-none focus:ring-2 focus:ring-secondary resize-none"
          rows={6}
        />
        <Field
          as={Textarea}
