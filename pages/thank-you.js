...
const Page = () => {
  return (
    <ThankYouBg
      backImage="/images/thank-you-bg.jpg"
      content={
        ...
        >
         <img
            ...
            src="/images/FiiCodeLogo1.png"
            alt="FiiCodeLogo"
          />
          <h2 className="mb-8 text-2xl font-bold text-black text-center">Thank you for choosing Pathly !</h2>
          
          <h3 className="mb-4 text-lg font-bold text-black">Next steps:</h3>
